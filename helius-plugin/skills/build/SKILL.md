...
If not available, try restarting Claude Code, or manually add: `claude mcp add helius npx helius-mcp@2.2.0` then restart. Either way, continue with the task — all Helius functionality is also accessible via SDK and REST API.
