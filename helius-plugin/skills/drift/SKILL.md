---
name: drift
description: Build Solana perpetual trading, spot trading, lending, and prediction market applications combining Drift Protocol with Helius infrastructure. Covers perp trading (40+ markets, up to 101x leverage), spot margin trading, JIT auctions, lending/borrowing, BET prediction markets, strategy vaults, liquidation engines, DLOB orderbook streaming, transaction submission via Sender, fee optimization, shred-level streaming via LaserStream, and wallet intelligence.
metadata:
  version: "1.0.0"
---
...
Helius MCP exposes routed public tools. When this skill names Helius actions like `getPriorityFeeEstimate`, `transactionSubscribe`, or `getAssetsByOwner`, translate them to the appropriate routed tool plus `action`.
...
```
The Helius MCP server failed to start. Try restarting your editor.
If the problem persists, reinstall or re-enable the Helius plugin so it can start the MCP server again.
```
...
### Perpetual Trading
**Read**: `references/drift-perps.md`, `references/helius-sender.md`, `references/helius-priority-fees.md`, `references/integration-patterns.md`
...
### Spot & Margin Trading
**Read**: `references/drift-spot.md`, `references/helius-sender.md`
...
### Lending & Borrowing
**Read**: `references/drift-lending.md`, `references/helius-das.md`
...
**Read**: `references/drift-predictions.md`, `references/helius-sender.md`
...
### Strategy Vaults
**Read**: `references/drift-vaults.md`, `references/drift-sdk.md`
...
**Read**: `references/helius-wallet-api.md`, `references/helius-das.md`, `references/drift-sdk.md`
...
**Read**: `references/helius-onboarding.md`, `references/drift-sdk.md`
...
- Helius MCP Server: `helius-mcp@latest` (managed by the Helius plugin)
