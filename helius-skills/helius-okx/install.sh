...
echo "     claude mcp add helius npx helius-mcp@2.2.0"
echo ""
echo "  2. OKX skill library (required):"
echo "     See install options at https://github.com/okx/onchainos-skills"
echo ""
echo "  3. OKX onchainos CLI (required):"
echo "     See install instructions at https://github.com/okx/onchainos-skills"
echo ""
echo "  4. API keys:"
