...
## [helius-mcp@2.2.0](https://github.com/helius-labs/core-ai/compare/helius-mcp@2.1.0...helius-mcp@2.2.0) - 2026-08-26

### Merged

- chore(mcp): bump helius-mcp to 2.2.0 [`#167`](https://github.com/helius-labs/core-ai/pull/167)
- fix(plugin): Stop Instructing Third-Party Installs the Agent Shouldn't Run [`#166`](https://github.com/helius-labs/core-ai/pull/166)
- fix(plugin): Finish the Router Migration and Single-source the MCP Pin [`#165`](https://github.com/helius-labs/core-ai/pull/165)
- fix(plugin): pin helius-mcp to an exact version and drop the DFlow connector [`#164`](https://github.com/helius-labs/core-ai/pull/164)
- feat(scripts): Generate Plugin And Cursor Refs From The Compiler With `--check Mode` [`#163`](https://github.com/helius-labs/core-ai/pull/163)
- fix(mcp): Refuse Runtime Config Mutation Under a Shared Credential [`#162`](https://github.com/helius-labs/core-ai/pull/162)
- Scope Result-handle Store Per Session [`#161`](https://github.com/helius-labs/core-ai/pull/161)
- chore(deps): bump chalk from 5.6.2 to 6.0.0 in /helius-cli [`#159`](https://github.com/helius-labs/core-ai/pull/159)
- chore(deps): bump the mcp-minor-patch group in /helius-mcp with 2 updates [`#158`](https://github.com/helius-labs/core-ai/pull/158)
- chore(deps): bump @types/node from 26.1.1 to 26.1.2 in /helius-cli in the cli-minor-patch group [`#157`](https://github.com/helius-labs/core-ai/pull/157)
- fix(mcp): Redact Helius API Key From Tool Output Under a Shared Credential [`#160`](https://github.com/helius-labs/core-ai/pull/160)
- Store Config With Owner-only Permissions [`#156`](https://github.com/helius-labs/core-ai/pull/156)
- chore(deps): bump typescript from 5.9.3 to 7.0.2 in /helius-mcp [`#151`](https://github.com/helius-labs/core-ai/pull/151)
- chore(deps): bump the cli-minor-patch group across 1 directory with 3 updates [`#150`](https://github.com/helius-labs/core-ai/pull/150)
- fix(mcp): Point docs fetcher at helius.dev instead of raw.githubusercontent.com [`#155`](https://github.com/helius-labs/core-ai/pull/155)
- chore(deps): bump @types/node from 20.19.33 to 26.1.1 in /helius-cli [`#152`](https://github.com/helius-labs/core-ai/pull/152)
- chore(deps): bump @types/node from 20.19.29 to 26.1.1 in /helius-mcp [`#153`](https://github.com/helius-labs/core-ai/pull/153)
- chore(deps): bump typescript from 5.9.3 to 7.0.2 in /helius-cli [`#154`](https://github.com/helius-labs/core-ai/pull/154)
- chore(deps): bump the mcp-minor-patch group in /helius-mcp with 3 updates [`#149`](https://github.com/helius-labs/core-ai/pull/149)
- chore(ci): bump actions/setup-node from 6 to 7 [`#148`](https://github.com/helius-labs/core-ai/pull/148)
- Update Solana Kit and Solana Program [`#147`](https://github.com/helius-labs/core-ai/pull/147)
- chore(deps): bump commander from 12.1.0 to 15.0.0 in /helius-cli [`#144`](https://github.com/helius-labs/core-ai/pull/144)
- chore(deps): bump ora from 8.2.0 to 9.4.1 in /helius-cli [`#146`](https://github.com/helius-labs/core-ai/pull/146)
- Refactor Regex-Parsing Output to Structured Continuation Metadata [`#137`](https://github.com/helius-labs/core-ai/pull/137)
- chore(ci): bump actions/cache from 5 to 6 [`#141`](https://github.com/helius-labs/core-ai/pull/141)
- chore: update CHANGELOG.md for helius-mcp@2.1.0 [`#140`](https://github.com/helius-labs/core-ai/pull/140)

## [helius-mcp@2.1.0](https://github.com/helius-labs/core-ai/compare/helius-mcp@2.0.0...helius-mcp@2.1.0) - 2026-06-24

### Merged

- chore(cli+mcp): Bump to 2.1.0 [`#139`](https://github.com/helius-labs/core-ai/pull/139)
...
- Add simulateTransaction Tool For Pre-Send Transaction Dry-Runs [`#135`](https://github.com/helius-labs/core-ai/pull/135)
- fix(cli): exit non-zero when reclaim batches fail to land [`#126`](https://github.com/helius-labs/core-ai/pull/126)
- Add Confirmation Prompt Before Submitting Transactions [`#134`](https://github.com/helius-labs/core-ai/pull/134)
- Add Confirmation Prompts For Destructive Commands [`#133`](https://github.com/helius-labs/core-ai/pull/133)
- chore(ci): bump actions/checkout from 4 to 7 [`#130`](https://github.com/helius-labs/core-ai/pull/130)
- chore(ci): bump actions/setup-node from 4 to 6 [`#132`](https://github.com/helius-labs/core-ai/pull/132)
- chore(ci): bump actions/cache from 4 to 5 [`#131`](https://github.com/helius-labs/core-ai/pull/131)
- chore(ci): bump pnpm/action-setup from 4 to 6 [`#129`](https://github.com/helius-labs/core-ai/pull/129)
...
- docs: Add missing packages, skills, and fix helius-phantom link [`#122`](https://github.com/helius-labs/core-ai/pull/122)
- chore: update CHANGELOG.md for helius-mcp@2.0.0 [`#125`](https://github.com/helius-labs/core-ai/pull/125)
